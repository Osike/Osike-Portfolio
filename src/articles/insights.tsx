...
const Insights: React.FC = () => {
  const article = articles.find(a => a.category === 'insights')!;
          ...
          {!article.image && (
            <header className="mb-8">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200 rounded-full text-sm font-medium">
                  {article.category}
                </span>
